...
public class VinCompareTrainCameraConnectionFragment extends Fragment {
      ...
      new TextureView.SurfaceTextureListener() {
        ...
        public void onSurfaceTextureAvailable(
          ...
          try {
            ...
            Size previewSize =
                VinCompareTrainCamera2ConnectionFragment.chooseOptimalSize(
  ...
  @SuppressLint("ValidFragment")
  public VinCompareTrainCameraConnectionFragment(
  ...
  public View onCreateView(
    ...
    /*overlayUrl = PreferenceStorage.getOverlayUrl(getActivity());
    if(overlayUrl != null) {
