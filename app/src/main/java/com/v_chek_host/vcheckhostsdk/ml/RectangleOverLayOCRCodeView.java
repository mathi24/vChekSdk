...
public class RectangleOverLayOCRCodeView extends LinearLayout {

    private Bitmap bitmap;

    public RectangleOverLayOCRCodeView(Context context) {

        super(context);

    }

    public RectangleOverLayOCRCodeView(Context context, AttributeSet attrs) {

        super(context, attrs);

    }

    public RectangleOverLayOCRCodeView(Context context, AttributeSet attrs, int defStyleAttr) {

        super(context, attrs, defStyleAttr);

    }

    public RectangleOverLayOCRCodeView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
