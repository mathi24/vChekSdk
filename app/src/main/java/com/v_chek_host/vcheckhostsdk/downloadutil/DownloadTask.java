...
public class DownloadTask {
    ...
    private String downloadUrl = "", downloadFileName = "",modelName ="";

    public DownloadTask(Context context, TextView buttonText, String downloadUrl, String modelName) {
        this.context = context;
        this.buttonText = buttonText;
        this.downloadUrl = downloadUrl;
        this.modelName = modelName;

        downloadFileName = downloadUrl.replace(downloadUrl, modelName);//Create file name by picking download file name from URL
    ...
    private class DownloadingTask extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... arg0) {
            try {
                ...
                modelFile = new File(modelStorage, downloadFileName);//Create Output file in Main File
                ...
                FileOutputStream fos = new FileOutputStream(modelFile);//Get OutputStream for NewFile Location
