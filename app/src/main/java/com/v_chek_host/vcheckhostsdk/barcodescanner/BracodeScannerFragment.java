...
import com.v_chek_host.vcheckhostsdk.barcodescanner.camera.CameraSource;
...
import com.v_chek_host.vcheckhostsdk.ocrscanner.OcrCaptureActivity;
...
public class BracodeScannerFragment extends Fragment implements BarcodeGraphicTracker.BarcodeUpdateListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_bracode_scanner, container, false);
        return view;
    }
  ...
  /*  @Override
    public boolean onTouchEvent(MotionEvent e) {
        ...
        return b || c || gestureDetector.onTouchEvent(e);
    }*/
    ...
    private boolean onTap(float rawX, float rawY) {
        ...
        if (best != null) {
            ...
            Objects.requireNonNull(getActivity()).setResult(CommonStatusCodes.SUCCESS, data);
            getActivity().finish();
            return true;
        }
        return false;
