...
package com.v_chek_host.vcheckhostsdk.ml.fragments;
...
import com.v_chek_host.vcheckhostsdk.ml.utils.FitTextureView;
...
public class VinCompareTrainCamera2ConnectionFragment extends Fragment {
  ...
  @SuppressLint("ValidFragment")
  private VinCompareTrainCamera2ConnectionFragment(
  ...
  public static VinCompareTrainCamera2ConnectionFragment newInstance(
          final ConnectionCallback callback,
          final OnImageAvailableListener imageListener,
          final int layout,
          final Size inputSize) {
    return new VinCompareTrainCamera2ConnectionFragment(callback, imageListener, layout, inputSize);
  }
  ...
  public View onCreateView(
   ...
   // overlayUrl = V2ModelActivity.modelOverlayUrl;
  /*  if(overlayUrl != null) {
  ...
  /** Opens the camera specified by {@link VinCompareTrainCamera2ConnectionFragment#}. */
