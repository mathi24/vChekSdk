...
package com.v_chek_host.vcheckhostsdk.tracking;
...
*/
  ...
  private static final int[] COLORSRED = {
          Color.RED,
          Color.RED,
          Color.RED,
          Color.RED,
  ...
  private static final int[] COLORSGREEN = {
          Color.GREEN,
          Color.GREEN,
          Color.GREEN,
          Color.GREEN,
  ...
  public synchronized void trackResults(final List<Detector.Recognition> results, final long timestamp,final String passFailColor) {
    logger.i("Processing %d results from %d", results.size(), timestamp);
    processResults(results,passFailColor);
  }
  ...
  private void processResults(final List<Detector.Recognition> results,String pfColor) {
    ...
    trackedRecognition.detectionConfidence = potential.first;
      ...
      if(pfColor.equals("green")){
        trackedRecognition.color = COLORSGREEN[trackedObjects.size()];
      }else{
        trackedRecognition.color = COLORSRED[trackedObjects.size()];
      }
