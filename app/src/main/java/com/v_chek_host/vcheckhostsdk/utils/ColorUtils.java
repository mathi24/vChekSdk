...
public class ColorUtils {
    ...
    private ArrayList<ColorName> initColorList() {
        ...
        colorList.add(new ColorName("Blue", 0x03, 0x1f, 0x4b));
        colorList.add(new ColorName("Blue", 0x04, 0x39, 0x6c));
        colorList.add(new ColorName("Blue", 0x03, 0x5b, 0x96));
        colorList.add(new ColorName("Blue", 0x64, 0x97, 0xb1));
        colorList.add(new ColorName("Blue", 0xb3, 0xcd, 0xe0));
        colorList.add(new ColorName("Grey", 0xC0, 0xC0, 0xC0));
        colorList.add(new ColorName("Grey", 0xA9, 0xA9, 0xA9));
        colorList.add(new ColorName("Grey", 0x80, 0x80, 0x80));
        colorList.add(new ColorName("Grey", 0x69, 0x69, 0x69));
