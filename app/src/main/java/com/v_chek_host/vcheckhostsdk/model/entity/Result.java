...
public class Result {
    ...
    public class ModelData extends Result {
        ...
        @SerializedName("is_testing_pass_image_retake")
        private int retakePass;

        @SerializedName("is_testing_fail_image_retake")
        private int retakeFail;
      ...
      /*  @SerializedName("color_name")
        ...
        @SerializedName("validation_rules_message")
        private String validationRulesMessage;
        ...
        public int getRetakePass() {
            return retakePass;
        }

        public int getRetakeFail() {
            return retakeFail;
        }
     ...
     /*   public List<String> getColorName() {
        ...
        public String getValidationRulesMessage() {
            return validationRulesMessage;
        }

        public void setValidationRulesMessage(String validationRulesMessage) {
            this.validationRulesMessage = validationRulesMessage;
        }
    ...
    public class ValidationRules extends Result{
        @SerializedName("in_rules")
        private List<InRules> inRulesDdata;

        @SerializedName("out_rules")
        private List<OutRules> outRulesDdata;

        public List<InRules> getInRulesDdata() {
            return inRulesDdata;
        }

        public void setInRulesDdata(List<InRules> inRulesDdata) {
            this.inRulesDdata = inRulesDdata;
        }

        public List<OutRules> getOutRulesDdata() {
            return outRulesDdata;
        }

        public void setOutRulesDdata(List<OutRules> outRulesDdata) {
            this.outRulesDdata = outRulesDdata;
        }
    }

    public class InRules extends Result{
        @SerializedName("object_name")
        private String objectName;

        @SerializedName("object_Accuracy")
        private String objectAccuracy;
        ...
        public String getObjectAccuracy() {
            return objectAccuracy;
        }

        public void setObjectAccuracy(String objectAccuracy) {
            this.objectAccuracy = objectAccuracy;
        }
    ...
    public class OutRules extends Result{
        @SerializedName("object_name")
        private String objectName;
