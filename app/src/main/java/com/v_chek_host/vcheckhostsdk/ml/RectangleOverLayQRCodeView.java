...
public class RectangleOverLayQRCodeView extends LinearLayout {

    private Bitmap bitmap;

    public RectangleOverLayQRCodeView(Context context) {

        super(context);

    }

    public RectangleOverLayQRCodeView(Context context, AttributeSet attrs) {

        super(context, attrs);

    }

    public RectangleOverLayQRCodeView(Context context, AttributeSet attrs, int defStyleAttr) {

        super(context, attrs, defStyleAttr);

    }

    public RectangleOverLayQRCodeView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
